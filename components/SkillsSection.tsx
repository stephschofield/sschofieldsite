  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "UI Design", level: 95, icon: <Figma className="h-4 w-4" /> },
        { name: "UX Research", level: 85, icon: <Lightbulb className="h-4 w-4" /> },
        ...
        { name: "Visual Design", level: 94, icon: <Palette className="h-4 w-4" /> },
      ],
    ...
    },
    {
      ...
      skills: [
        { name: "HTML/CSS", level: 98, icon: <Code2 className="h-4 w-4" /> },
        { name: "JavaScript", level: 92, icon: <Code2 className="h-4 w-4" /> },
        { name: "TypeScript", level: 88, icon: <Code2 className="h-4 w-4" /> },
        { name: "React", level: 95, icon: <Code2 className="h-4 w-4" /> },
        { name: "Next.js", level: 90, icon: <Code2 className="h-4 w-4" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "App Performance", level: 85, icon: <Gauge className="h-4 w-4" /> },
      ],
                                  ...
                                  : category.id === "frontend"
                                    ...
                                    : category.id === "backend"
                                      ...
                                      : category.id === "mobile"
                                        ...
                                        : "Streamlined development workflows for faster delivery"}
                              </span>
                            </div>
                          </div>
                        </div>
